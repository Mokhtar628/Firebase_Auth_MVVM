    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: _currentPage == 1
            ? IconButton(
          icon: const Icon(Icons.arrow_back, color: AppColors.secondary,size: 24,),
          onPressed: () {
            ...
            child: PageView(
              ...
              children: [
                ...
                _buildPage(
                  ...
                  '',
                  'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor',
                  imagePath: 'assets/images/delivery_guy.png',
                  isLast: true,
                ),
              ],
            ),
      ...
      children: List.generate(
        3,
          ...
          decoration: BoxDecoration(
            color: _currentPage == index ? AppColors.activeColorIndicator : AppColors.inActiveColorIndicator,
